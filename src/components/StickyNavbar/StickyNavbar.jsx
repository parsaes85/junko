    ...
    <div className={`fixed ${scrollPosition > 100 ? "top-0 visible opacity-100 transition-all duration-[400ms]" : "-top-8 opacity-0 invisible"} left-0 z-[99] w-full bg-white bg-opacity-95 shadow hidden lg:flex items-center justify-between  px-4 py-3 xs:px-24`}>
      ...
      <div className="flex items-center gap-12">
        <ul id="sticky-navbar" className="flex gap-12 text-[15px] xl:text-base">
          ...
          <li>
            <NavLink to="/shop" className="link hover:text-primaryBlue transition">
              فروشگاه
            </NavLink>
          </li>
          <li>
            <NavLink to="/blog" className="link hover:text-primaryBlue transition">
              بلاگ
            </NavLink>
          </li>
          <li>
            <NavLink to="/about" className="link hover:text-primaryBlue transition">
              درباره ما
            </NavLink>
          </li>
          <li>
            <NavLink to="/contact" className="link hover:text-primaryBlue transition">
              تماس با ما
            </NavLink>
          </li>
        </ul>
