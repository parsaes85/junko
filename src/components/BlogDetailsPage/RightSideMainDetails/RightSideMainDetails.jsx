  ...
  return (
    <div className="border-b pb-6 mb-14">
      <div className="mb-6">
        ...
        <img src="/images/blog-big1.jpg" alt="" />
      </div>
      <div className="space-y-8 [&_p]:leading-7">
        ...
        <div className="flex items-center justify-between">
          <div className="flex gap-1 items-center">
            <p>برجسب ها: </p>
            <div>
              <Link className="hover:text-primaryBlue transition">مد</Link>,{" "}
              <Link className="hover:text-primaryBlue transition">تیشرت</Link>,{" "}
              <Link className="hover:text-primaryBlue transition">سفید</Link>
            </div>
          </div>
